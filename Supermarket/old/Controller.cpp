...
{
	checkList.addItem(products.find(_name)->second, _id);
}

double Controller::averageMonthlyConsumption(int _todayMonth,int _year)
{
	return checkList.averageMonthlyConsumption(_todayMonth, _year);
}
